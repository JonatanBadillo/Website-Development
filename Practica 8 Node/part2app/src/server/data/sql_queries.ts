const baseSql = `
SELECT Results.*, name, age, years, nextage FROM Results INNER JOIN People ON personId = People.id
...
INSERT INTO Calculations (age, years, nextage) SELECT $age, $years, $nextage
WHERE NOT EXISTS
...
CROSS JOIN Calculations WHERE People.name = $name AND Calculations.age = $age
